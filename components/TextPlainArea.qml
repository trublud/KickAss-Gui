...
TextArea {
    ...
    states: [
        State {
            name: "black";
            when: textArea.themeTransition && KickAssComponents.Style.blackTheme
            PropertyChanges {
                target: textArea
                color: {
                    return textArea.colorBlackTheme ? textArea.colorBlackTheme : KickAssComponents.Style._b_defaultFontColor
                }
            }
        }, State {
            name: "white";
            ...
            PropertyChanges {
                target: textArea
                color: {
                    return textArea.colorWhiteTheme ? textArea.colorWhiteTheme : KickAssComponents.Style._w_defaultFontColor
                }
            }
        }
    ]
